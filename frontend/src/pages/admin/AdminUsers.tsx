      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <Card className="p-4 bg-gradient-to-br from-blue-50 to-blue-100 border-blue-200">
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-blue-900">{users.filter((u: any) => u.role !== 'ADMIN').length}</p>
              </div>
          ...
          <Card className="p-4 bg-gradient-to-br from-green-50 to-green-100 border-green-200">
            <div className="flex items-start justify-between">
              <div>
                <p className="text-xs font-medium text-green-600 mb-1">Active Users</p>
          ...
          <Card className="p-4 bg-gradient-to-br from-red-50 to-red-100 border-red-200">
            <div className="flex items-start justify-between">
              <div>
                <p className="text-xs font-medium text-red-600 mb-1">Blocked Users</p>
          ...
          <Card className="p-4 bg-gradient-to-br from-purple-50 to-purple-100 border-purple-200">
            <div className="flex items-start justify-between">
              <div>
                <p className="text-xs font-medium text-purple-600 mb-1">Total Orders</p>
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 gap-4">
            {users.filter((user: any) => user.role !== 'ADMIN').map((user: any) => (
              <Card key={user.id} className="p-4 hover:shadow-md transition-all duration-200 border-slate-200">
                ...
                {/* Mobile Info */}
                <div className="lg:hidden flex flex-wrap gap-2 mt-3 pt-3 border-t">
                  ...
                  <Badge 
                    variant={user.isActive ? "default" : "destructive"}
                    className={user.isActive ? 'bg-green-100 text-green-800 text-xs hover:bg-green-100' : 'bg-red-100 text-red-800 text-xs hover:bg-red-100'}
                  >
                    {user.isActive ? '✓ Active' : '✕ Blocked'}
                  </Badge>
                </div>
